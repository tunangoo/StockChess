...
import stock.android.chess.activities.BaseActivity;
        ...
        _lvStart.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                if (arrString[arg2].equals(getString(R.string.pgntool_export_explanation))) {
                    ...
                    if (sEngine != null) {
                        File f = new File("/data/data/stock.android.chess/" + sEngine);
                        if (f.delete()) {
                    ...
                    if (sDatabase != null) {
                        File f = new File("/data/data/stock.android.chess/" + sDatabase);
                        if (f.delete()) {
