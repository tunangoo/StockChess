package stock.android.chess.play;
...
import stock.android.chess.GamesListActivity;
import stock.android.chess.helpers.Clipboard;
import stock.android.chess.helpers.MyPGNProvider;
import stock.android.chess.R;
import stock.android.chess.activities.ChessBoardActivity;
import stock.android.chess.activities.GlobalPreferencesActivity;
import stock.android.chess.constants.ColorSchemes;
import stock.android.chess.engine.EngineApi;
import stock.android.chess.engine.EngineListener;
import stock.android.chess.engine.LocalEngine;
import stock.android.chess.helpers.PGNHelper;
import stock.android.chess.helpers.ResultDialogListener;
import stock.android.chess.services.ClockListener;
import stock.android.chess.services.EcoService;
import stock.android.chess.services.GameApi;
import stock.android.chess.services.LocalClockApi;
import stock.android.chess.views.CapturedCountView;
import stock.android.chess.views.ChessPieceView;
import stock.android.chess.views.ChessPiecesStackView;
import stock.chess.Move;
import stock.chess.PGNColumns;
import stock.chess.board.BoardConstants;
...
//            }
    ...
    protected void onResume() {
        ...
        if (sOpeningDb == null) {
            try {
                ((LocalEngine) myEngine).installDb(getAssets().open("db.bin"), "/data/data/stock.android.chess/db.bin");
            } catch (Exception e) {
        ...
        switch (requestCode) {
            case REQUEST_MENU:
                ...
                if (item.equals(getString(R.string.menu_game_settings))) {
                    ...
                    intent = new Intent();
                    intent.setClass(PlayActivity.this, stock.android.chess.setup.SetupActivity.class);
